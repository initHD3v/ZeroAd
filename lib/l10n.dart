...
class AppLocalizations {
  ...
  String get scanningStatus =>
      isId ? "Memindai aplikasi..." : "Scanning apps...";
  String get scanIdle =>
      isId ? "Tekan pindai untuk memulai" : "Press scan to check device";
  String get threatsDetected =>
      isId ? "Ancaman ditemukan!" : "Threats detected!";
  String get systemClean =>
      isId ? "Sistem terlihat aman." : "System looks clean.";
  ...
  String get noAdwareFound => isId
      ? "Tidak ada adware terdeteksi.\nAnda aman!"
      : "No adware detected.\nYou are safe!";

  // --- SHIELD TAB ---
  String get shieldTitle => isId ? "Perisai Jaringan" : "Network Shield";
  String get protectionActive =>
      isId ? "Perlindungan Aktif" : "Protection Active";
  String get protectionDisabled =>
      isId ? "Perlindungan Mati" : "Protection Disabled";
  String get adGuardActive => isId
      ? "DNS AdGuard sedang memfilter iklan."
      : "AdGuard DNS is filtering ads.";
  String get enableToBlock => isId
      ? "Aktifkan untuk memblokir iklan di semua aplikasi."
      : "Enable to block ads across all apps.";
  ...
  String get blockedRequests =>
      isId ? "Permintaan Diblokir" : "Blocked Requests";
  String get realTimeLog =>
      isId ? "Log penyaringan DNS real-time" : "Real-time DNS filtering log";
  String get clearBtn => isId ? "Bersihkan" : "Clear";
  String get noTraffic =>
      isId ? "Belum ada lalu lintas..." : "No traffic detected yet...";
  String get shieldInactive =>
      isId ? "Perisai tidak aktif" : "Shield is inactive";
  ...
  String get trustAppDesc => isId
      ? "Izinkan semua aktivitas dari aplikasi ini."
      : "Allow all activities from this app.";
  String get trustDomainDesc => isId
      ? "Hanya izinkan alamat spesifik ini."
      : "Only allow this specific address.";
  ...
  String get recommendationLabel =>
      isId ? "Saran Tindakan:" : "Recommendation:";
