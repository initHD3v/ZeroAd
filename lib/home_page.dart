...
class _MyHomePageState extends State<MyHomePage>
                      ...
                      Row(
                        ...
                        children: [
                          _buildIconButton(
                            ...
                            "GitHub",
                            () => _launchUrl(
                              "https://github.com/initHD3v/ZeroAd",
                            ),
                          ),
                          _buildIconButton(
                            context,
                            ...
                            "Email",
                            () => _launchUrl(
                              "mailto:arunapicturee@gmail.com?subject=ZeroAd Feedback",
                            ),
                          ),
                          _buildIconButton(
                            context,
                            ...
                            "Share",
                            () => Share.share(
                              "Lindungi HP kamu dari adware dengan ZeroAd! Download di: https://github.com/initHD3v/ZeroAd",
                            ),
                          ),
                        ],
                      ),
          ...
          body: IndexedStack(
            ...
            children: [
              ...
              ActivityTab(
                ...
                onShowAppDetails: (name, pkg, logs) =>
                    _showAppDetails(context, security, name, pkg, logs),
  ...
  String _getTitle(AppLocalizations l10n) {
    switch (_currentIndex) {
      case 0:
        return l10n.scanTitle;
      case 1:
        return l10n.shieldTitle;
      default:
        return l10n.liveActivity;
    }
  }
  ...
  void _showAppDetails(
    ...
    final allowedLogs = logs
        .where(
          (l) =>
              l.contains('ALLOWED') ||
              l.contains('APP_WHITELISTED') ||
              l.contains('DNS_QUERY'),
        )
        .toList();
    final blockedLogs = logs
        .where((l) => l.contains('BLOCKED') || l.contains('AD_CONTENT'))
        .toList();
          ...
          child: DefaultTabController(
            ...
            child: Column(
              children: [
                ...
                if (packageName == "com.android.system" ||
                    packageName.startsWith("system.uid"))
                  Container(
    ...
    if (filteredLogs.isEmpty) {
      return Center(
        child: Column(
          ...
          children: [
            Icon(
              isSafe ? Icons.cloud_done_outlined : Icons.security_outlined,
              size: 48,
              color: Colors.grey.withAlpha(100),
            ),
            const SizedBox(height: 16),
            Text(
              isSafe ? "Belum ada trafik aman" : "Tidak ada iklan terdeteksi",
        ...
        return ListTile(
          ...
          trailing: isSafe
              ? const Icon(
                  ...
                  color: Colors.amber,
                  size: 14,
                ) // Menandakan jalur cepat/ISP Direct
              : null,
        );
      },
    );
